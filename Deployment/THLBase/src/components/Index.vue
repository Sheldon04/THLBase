  ...
  <div>
    ...
    <div class="intro">
      <el-collapse v-model="activeName" accordion>
        <el-collapse-item title="Introduction" name="1" class="step">
          <div>This project aims to build <b>a sequencing database for miRNA studies in cows</b> (Chinese Holstein
        ...
        <el-collapse-item title="Features" name="2" class="step">
          <ul>
            <li>Linked miRNA database to Microsoft Academic and other academic websites to realize real-time update of
              search results corresponding to literature.
            </li>
            <li> An RNA database based on cow transcriptome sequencing data has been established to fill the gap in this
              type of database.
            </li>
            <li>Integrate data from multiple databases, display the results completely, and realize data visualization
              at the same time.
            </li>
          </ul>
        </el-collapse-item>
    ...
    <div class="block">
      <el-carousel height="600px">
        <el-carousel-item v-for="item in imgs" :key="item" class="el-carousel__item">
